...
public class LifeChoiceHomeJointLifeWithConv {
    ...
    public static void setup() {
        ...
        DateTime dob1 = stringToDate("22/01/1971");
    ...
    private static BenefitInputs setupBenefitLSODInputsLife1(Policy policy) {
        ...
        benefitInputs.setConversionFactor(1.10);
    ...
    public void unratedPremium() {
        assertEquals("Unrated premium", 258.68, policy.getResult().getUnratedPremium(), 0.01);
    }

    @Test
    public void extraMortality() {
        assertEquals("Extra mortality", 30.01, policy.getResult().getExtraMortalityCost(), 0.01);
    }

    @Test
    public void perMille() {
        assertEquals("Per mille", 52.56, policy.getResult().getPerMilleCost(), 0.01);
    }

    @Test
    public void totalRatings() {
        assertEquals("Total ratings", 82.58, policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }

    @Test
    public void totalPremium() {
        assertEquals("Total premium", 341.27, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }
}
