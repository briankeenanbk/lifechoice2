...
public class LifeChoiceYandFSingleEBQ2 {
    ...
    public static void setup() {
        ...
        DateTime dob = stringToDate("26/08/1979");
    ...
    private static BenefitInputs setupBenefitLSODInputs(Policy policy) {
        ...
        benefitInputs.setSumAssured(360000);
    ...
    public void unratedPremium() {
        assertEquals("Unrated premium", 29.6, policy.getResult().getUnratedPremium(), 0.01);
    }
    ...
    public void totalPremium() {
        assertEquals("Total premium", 29.6, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }
