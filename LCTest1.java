...
public class LCTest1 {
    ...
    public void unratedPremium() {
        assertEquals("Unrated premium", 36.81, policy.getResult().getUnratedPremium(), 0.01);
    }
    ...
    public void totalPremium() {
        assertEquals("Total premium", 36.81, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }

    @Test
    public void totalPremiumIncludingLevy() {
        assertEquals("Total premium", 37.17, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost() + ((policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost()) * .01), 0.01);
    }
