...
public class LifeChoiceFamilySingleLifeIncomeOnDeathWithExtraMortalityTest2 {
    ...
    public static void setup() {
        ...
        DateTime dob = stringToDate("07/10/1971");
    ...
    public void unratedPremium() {
        assertEquals("Unrated premium", 1689.67, policy.getResult().getUnratedPremium(), 0.01);
    }

    @Test
    public void extraMortality() {
        assertEquals("Extra mortality", 384.64, policy.getResult().getExtraMortalityCost(), 0.01);
    }
    ...
    public void totalRatings() {
        assertEquals("Total ratings", 384.64, policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }

    @Test
    public void totalPremium() {
        assertEquals("Total premium", 2074.31, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }
