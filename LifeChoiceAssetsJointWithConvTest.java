...
public class LifeChoiceAssetsJointWithConvTest {
   ...
   private static PolicyInputs setupPolicyInputs(DateTime policyStartDate) {
    ...
    public void unratedPremium() {
        assertEquals("Unrated premium", 391.79, policy.getResult().getUnratedPremium(), 0.01);
    }

    @Test
    public void extraMortality() {
        assertEquals("Extra mortality", 39.90, policy.getResult().getExtraMortalityCost(), 0.01);
    }
    ...
    public void totalRatings() {
       assertEquals("Total ratings", 90.55, policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }

    @Test
    public void totalPremium() {
        assertEquals("Total premium", 482.35, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }
}
