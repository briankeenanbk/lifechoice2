...
public class LifeChoiceFamilySingleLifeAccSpecWithExtraMortalityTest {
    ...
    public void extraMortality() {
       assertEquals("Extra mortality", 26.77, policy.getResult().getExtraMortalityCost(), 0.01);
    }
    ...
    public void totalRatings() {
        assertEquals("Total ratings", 26.77, policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }

    @Test
    public void totalPremium() {
        assertEquals("Total premium", 300.65, policy.getResult().getUnratedPremium() + policy.getResult().getExtraMortalityCost() + policy.getResult().getPerMilleCost(), 0.01);
    }
